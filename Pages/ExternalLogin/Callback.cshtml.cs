...
namespace ids.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        var cookieKeys = string.Join(",", HttpContext.Request.Cookies.Keys);
        var externalAuthenticationSchemeCookieKey = IdentityServerConstants.ExternalCookieAuthenticationScheme;
        var externalAuthenticationSchemeCookie = HttpContext.Request.Cookies[externalAuthenticationSchemeCookieKey];
